...
<span>日</span>
   <select name="beginHour" id="BeginYearInput" class="span1 ">
      <option value="">01</option>
      <option value="">02</option>
      <option value="">03</option>
      <option value="">04</option>
...
<span>时</span>
 <select name="beginMinute" id="BeginYearInput" class="span1 ">
      <option value="">01</option>
      <option value="">02</option>
      <option value="">03</option>
      <option value="">04</option>
...
<span>分</span>
 ...
 <td>
    <label for="StateInput">状态 :</label>
      <select name="State" id="StateInput" class="span2">
...
<span>日</span>
   <select name="endHour" id="BeginYearInput" class="span1 ">
      <option value="">01</option>
      <option value="">02</option>
      <option value="">03</option>
      <option value="">04</option>
...
<span>时</span>
   <select name="endMinute" id="BeginYearInput" class="span1 ">
      <option value="">01</option>
      <option value="">02</option>
      <option value="">03</option>
      <option value="">04</option>
...
<td>
<input style="" type="submit" class="btn  btn-large btn-success" value="查询">
</td>
  </tr>
