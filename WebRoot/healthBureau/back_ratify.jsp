    ...
    <body>
        ...
        <!-- <table class="table table-unbordered"> 
           <tr>
                ...
                <td class="span2" id="ri">建单时间 ： </td><td><input type="text" ></td>
                <td class="span2" id="ri">提交时间 ： </td><td><input type="text" ></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td  class="span2" id="ri"></td><td><button class="btn btn-primary">查询</button></td>
